package org.eclipse.scout.orga.server.bookmarks;
...
public class BookmarkService extends AbstractBaseService<Bookmark, BookmarkRecord> {
	...
	public BookmarkFolder getFolder(String id) {
		...
		try {
			BookmarkFolder bookmarkFolder = SerializationUtility.createObjectSerializer()
					.deserialize(data, BookmarkFolder.class);
