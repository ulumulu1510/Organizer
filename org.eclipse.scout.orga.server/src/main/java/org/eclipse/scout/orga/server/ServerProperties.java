...
public class ServerProperties {
	...
	public static final String KEY_USERNAME = "org.eclipse.scout.orga.server.sql.username";
	public static final String KEY_PASSWORD = "org.eclipse.scout.orga.server.sql.password";
