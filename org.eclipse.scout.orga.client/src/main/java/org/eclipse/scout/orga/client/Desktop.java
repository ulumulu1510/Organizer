package org.eclipse.scout.orga.client;
...
import org.eclipse.scout.orga.client.admin.AdminOutline;
import org.eclipse.scout.orga.client.user.ProfileForm;
import org.eclipse.scout.orga.client.work.WorkOutline;
import org.eclipse.scout.orga.shared.FontAwesomeIcons;
import org.eclipse.scout.orga.shared.Icons;
import org.eclipse.scout.orga.shared.ViewAdminOutlinePermission;
...
public class Desktop extends AbstractDesktop {
	...
	public class UserMenu extends AbstractMenu {
		...
		public class LogoutMenu extends AbstractMenu {
			...
			@Override
			protected void execAction() {
				ClientSessionProvider.currentSession(ClientSession.class)
						.stop();
			}
		}
	}
	 ...
	 * DisplayStyle.TAB; }
	 * 
	 * @Override protected String getConfiguredKeyStroke() { return
	 * IKeyStroke.F3; } }
	 */
