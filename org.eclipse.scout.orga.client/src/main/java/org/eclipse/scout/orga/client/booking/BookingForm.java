...
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.CancelButton;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.DescriptionBox;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.DescriptionBox.DescriptionField;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.DescriptionBox.UserIdField;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.InformationBox;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.InformationBox.DocumentTableField;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.InformationBox.NoteField;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.OkButton;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.TechnicalBox;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.TechnicalBox.ActiveField;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.TechnicalBox.BookingIdField;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.TimeBox;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.TimeBox.DateFromField;
import org.eclipse.scout.orga.client.booking.BookingForm.MainBox.TimeBox.DateToField;
...
public class BookingForm extends AbstractForm {
	...
	public class MainBox extends AbstractGroupBox {
		...
		public class TimeBox extends AbstractGroupBox {
			...
			@Order(1000)
			@ClassId("d3deb50b-1579-48e2-a893-0d626005fbff")
			...
			@Order(2000)
			@ClassId("8a5d83be-c984-47b8-a256-e5f5d5a508e0")
