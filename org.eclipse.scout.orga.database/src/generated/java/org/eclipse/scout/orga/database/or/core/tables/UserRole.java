...
public class UserRole extends TableImpl<UserRoleRecord> {
    ...
    private static final long serialVersionUID = 1661399308;
     ...
     */
    public final TableField<UserRoleRecord, String> USERNAME = createField("USERNAME", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>core.USER_ROLE.ROLE_NAME</code>.
     */
    public final TableField<UserRoleRecord, String> ROLE_NAME = createField("ROLE_NAME", org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");
