...
public class DateTimeUtilityTest {
	...
	public void simpleConversionTest() {
		...
		assertTrue("Time objects not working with isEqual()", DateTimeUtility.convert(SOME_TIME_STRING)
				.isEqual(SOME_TIME_OBJECT));
		...
		assertTrue("Now objects not working with isEqual()", DateTimeUtility.convert(nowString)
				.isEqual(nowTime));
	}
