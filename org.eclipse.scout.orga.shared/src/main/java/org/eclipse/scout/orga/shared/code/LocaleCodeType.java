...
public class LocaleCodeType extends BaseCodeType {
	 ...
	 * Does not check if the provided corresponds to an existing code of this
	 * code type and only works for cases implemented in
	...
	/**
	 * Convenience method that directly works with a locale object to return the
	 * code. Only works for cases implemented in {@link Locale#toLanguageTag()}.
	 */
