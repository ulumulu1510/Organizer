...
public class DateTimeUtility {
	...
	public static DateTimeFormatter DEFAULT_FORMATTER = DateTimeFormatter.ofPattern(DEFAULT_PATTERN)
			.withZone(DEFAULT_ZONE);

	/**
	 * Convenience method to create string that may be directly saved in the
	 * database.
	 */
	...
	/**
	 * This function is design to convert ZonedDateTime object from other system
	 * to a stable ISO dateTime String.
	 * {@see https://stackoverflow.com/questions/43634226/zoneddatetime-tostring-compatability-with-iso-8601}
	 * 
	 * @param date
	 *            zoned date time {@link ZonedDateTime}
	 * @return 'yyyy-MM-ddTHH:mm:ssZ' format ISO dateTime string
	 */
	public static String convert(ZonedDateTime timeInUtc) {
		return timeInUtc == null ? null : ZonedDateTime.ofInstant(timeInUtc.toInstant(), DEFAULT_ZONE)
				.format(DEFAULT_FORMATTER);
	}

	/**
	 * Converts the provided date and time zone into a utc timestamp in string
	 * format.
	 */
	// TODO add test cases
