...
/**
 * This class holds references to complex field parts. In docx, a complex field
 * represents dynamic data like document variables, dates and times or
 * functions.
 * <p/>
 ...
 * </pre>
 * <p/>
 * <b>Note:</b> The separate complex field character and therefore the default
 * value paragraph entries as well are optional.
 * 
 * @since 1.0.0
 */
public class DocxComplexField {
	...
	/**
	 * @return Returns the parent run of the complex field's separate element or
	 *         <code>null</code> if the complex field does not have a separate
	 *         section at all.
	 */
	...
	/**
	 * Adds a document node that is part of the code section (i.e. the field's
	 * formula).
	 * 
	 * @param defaultValue
	 */
	...
	/**
	 * @return Returns the document nodes that are part of the complex field's
	 *         part between its start and separate elements. If the complex
	 *         field does not have a separate section, the document nodes
	 *         between the start and end elements are returned. The result is
	...
	/**
	 * Adds a document node that is part of the separate section (i.e. the
	...
	/**
	 * @return Returns the document nodes that are part of the complex field's
	 *         separate section. The result is never <code>null</code>.
	 */
